...
async function setBasicIndex(accounts) {
  ...
  console.log(
    "account.sol contract index variable Address:",
    await accountInstance.instaIndex()
  );
  console.log(
    "list.sol contract index variable Address:",
    await listInsance.instaIndex()
  );
  console.log(
    "connectors.sol contract index variable Address:",
    await connectorsInsance.instaIndex()
  );
